...
class test_getTnbList(unittest.TestCase):
    ...
    def test_getTnbList_contains_200_faultcode(self):
        ...
        self.assertEqual(response_json['faultCode'], '200')
        print(response_json)

    def test_getTnbList_contains_correct_faultString(self):
        response_json = self.make_post_request(get_tnb_list_no_params_request).json()

        self.assertEqual(response_json['faultString'], 'Method success')
    ...
    def test_no_param_getTnbList_yields_telekom(self):
        ...
        self.assertEqual(response_json['faultCode'], '200')
        self.assertEqual(response_json['faultString'], 'Method success')
        self.assertEqual(response_json['tnbs'], [{'name': 'Deutsche Telekom', 'tnb': 'D001', 'isTnb': False,}])
    ...
    def test_getTnbList_with_d001_param_yields_telekom_and_tnb_true(self):
        ...
        self.assertEqual(response_json['faultCode'], '200')
        self.assertEqual(response_json['faultString'], 'Method success')
        self.assertEqual(response_json['tnbs'], [{'isTnb': True, 'name': 'Deutsche Telekom', 'tnb': 'D001'}, {'isTnb': True, 'name': 'T-Mobile', 'tnb': 'D001'}])
    ...
    def test_getTnbList_with_y123_param_yields_random_carrier_and_tnb_false(self):
        ...
        self.assertEqual(response_json['faultCode'], '200')
        self.assertEqual(response_json['faultString'], 'Method success')
        self.assertEqual(response_json['tnbs'], [{'tnb': 'D001', 'isTnb': False, 'name': 'Deutsche Telekom'},{'isTnb': False, 'name': 'Random Carrier', 'tnb': 'Y123'}])
    ...
    def test_getTnbList_with_y123_param_yields_random_carrier_and_tnb_true(self):
        ...
        self.assertEqual(response_json['faultCode'], '200')
        self.assertEqual(response_json['faultString'], 'Method success')
        self.assertEqual(response_json['tnbs'], [{'tnb': 'D001', 'isTnb': False, 'name': 'Deutsche Telekom'},{'isTnb': True, 'name': 'Random Carrier', 'tnb': 'Y123'}])
    ...
    def test_getTnbList_in_correct_order_no_param_request(self):
        ...
        self.assertEqual(response_json['faultCode'], '200')
        self.assertEqual(response_json['faultString'], 'Method success')
        self.assertEqual(response_json['tnbs'], test_getTnbList_in_correct_order_no_param_response)
    ...
    def test_getTnbList_in_correct_order_D905_param(self):
        ...
        self.assertEqual(response_json['faultCode'], '200')
        self.assertEqual(response_json['faultString'], 'Method success')
        self.assertEqual(response_json['tnbs'], test_getTnbList_in_correct_order_D905_param_response)

    def test_getTnbList_filter_D146(self):
        d001 = database.Tnb(tnb="Y123",name="Random Carrier")
